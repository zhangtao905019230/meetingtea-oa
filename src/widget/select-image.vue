      ...
      <div>
        <el-form>
          <el-form-item label="图片路径：">
            ...
            <el-button @click="getMdContent" v-loading.fullscreen.lock="fullscreenLoading">显示该文件内容</el-button>
          </el-form-item>
        </el-form>
        <div id="elfinder"></div>
    ...
    methods:{
      ...
      getMdContent(){
        ...
        axios.get(_this.PHP_interface,{params: {
            ...
            cmd : 'get',
            conv:1,
            target:_this.currentlySelectedFiles[0]
          }}).
        then(res => {
          _this.fullscreenLoading = false;
          _this.selectImageUrl = res.data.content
          console.log(res,111)
        })
      },
      confirmSelect(){
